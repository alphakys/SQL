...
올림차순(ASC)으로 가장 선임부터 출력이 되도록 하세요. 이름(first_name last_name),
월급(salary),  전화번호(phone_number), 입사일(hire_date) 순서이고 “이름”, “월급”,
“전화번호”, “입사일” 로 컬럼이름을 대체해 보세요.
*/
...
select first_name,
        ...
        salary
from employees
where salary >3000 and manager_id is not null;
--더 생각해보기
select first_name,
        manager_id,
